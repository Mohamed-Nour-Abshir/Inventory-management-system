		...
		<div class="row">
			<div class="col-lg-12">
				<div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
					...
					@if($rolePermission->can('Brand Create'))
						<a href="{{ route('brand.create') }}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Brand</a>
					@endif
				</div>
			</div>
			<div class="col-lg-12">
								...
								<td>
									<div class="d-flex align-items-center list-action">
										<a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
											href="{{ route('brand.show', $item->id) }}"><i class="ri-pencil-line mr-0"></i></a>
									@if($rolePermission->can('Brand Delete'))
